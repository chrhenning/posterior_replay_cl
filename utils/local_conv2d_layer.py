...
.. autosummary::
    ...
    utils.local_conv2d_layer.LocalConv2dLayer
"""
import numpy as np
import torch
...
class LocalConv2dLayer(nn.Module):
    ...
    **Implementation details**
    ...
    Attributes:
        ...
        out_height: Height of the output feature maps.
        out_width: Width of the output feature maps.
    ...
    @property
    def out_height(self):
        """Getter for read-only attribute :attr:`out_height`.
    ...
    @property
    def out_width(self):
        """Getter for read-only attribute :attr:`out_width`.
