...
class HPerturbWrapper(nn.Module, HyperNetInterface):
    ...
    Attributes:
        internal_hnet (hnets.hnet_interface.HyperNetInterface): The underlying
            hypernetwork that was passed via constructor argument ``hnet``.
    ...
    def internal_hnet(self):
        """Getter for read-only attribute :attr:`internal_hnet`."""
        return self._hnet
