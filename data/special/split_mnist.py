...
def get_split_MNIST_handlers(data_path, use_one_hot=True, validation_size=0,
    ...
    """
    warn('Please use function "get_split_mnist_handlers" instead.',
         DeprecationWarning)

    return get_split_mnist_handlers(data_path, use_one_hot=use_one_hot,
        validation_size=validation_size,  num_classes_per_task=steps,
        num_tasks=None)
