...
"""
Hyperparameter-search configuration for CIFAR-Resnet with BbB
-------------------------------------------------------------
...
:mod:`probabilistic.prob_cifar.train_resnet_bbb`.
"""
...
# script.
_SCRIPT_NAME = 'train_resnet_bbb.py'
