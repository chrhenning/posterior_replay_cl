...
#
# title          :probabilistic/prob_cifar/hpsearch_config_zenke_avb.py
# author         :ch
...
"""
Hyperparameter-search configuration for CIFAR-Zenke using AVB
-------------------------------------------------------------
...
:mod:`probabilistic.prob_cifar.train_zenke_avb`.
...
# script.
_SCRIPT_NAME = 'train_zenke_avb.py'
