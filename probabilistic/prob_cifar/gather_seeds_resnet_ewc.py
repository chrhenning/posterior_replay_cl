...
#
# @title          :probabilistic/prob_cifar/gather_seeds_resnet_ewc.py
# @author         :ch
...
:mod:`probabilistic.prob_cifar.hpsearch_config_resnet_ewc`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run( \
        'probabilistic.prob_cifar.hpsearch_config_resnet_ewc',
