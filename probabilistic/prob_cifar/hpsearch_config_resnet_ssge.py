...
#
# title          :probabilistic/prob_cifar/hpsearch_config_resnet_ssge.py
# author         :ch
...
"""
Hyperparameter-search configuration for CIFAR-Resnet using SSGE
---------------------------------------------------------------
...
:mod:`probabilistic.prob_cifar.train_resnet_ssge`.
"""
...
# script.
_SCRIPT_NAME = 'train_resnet_ssge.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='cifar_resnet_ssge', argv=argv)
