...
#
# title          :probabilistic/prob_cifar/hpsearch_config_resnet_avb.py
# author         :ch
...
"""
Hyperparameter-search configuration for CIFAR-Resnet using AVB
--------------------------------------------------------------
...
:mod:`probabilistic.prob_cifar.train_resnet_avb`.
"""
...
# script.
_SCRIPT_NAME = 'train_resnet_avb.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='cifar_resnet_avb', argv=argv)
