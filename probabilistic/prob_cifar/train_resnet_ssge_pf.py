...
#
# @title           :probabilistic/prob_cifar/train_resnet_ssge_pf.py
# @author          :mc
...
# @python_version  :3.7
"""
Train implicit prior-focused for CIFAR-10/100 with SSGE and Resnet-32
---------------------------------------------------------------------
...
if __name__ == '__main__':
    config = train_args.parse_cmd_arguments(mode='cifar_resnet_ssge_pf')

    train_avb.run(config, experiment='cifar_resnet_ssge_pf')
