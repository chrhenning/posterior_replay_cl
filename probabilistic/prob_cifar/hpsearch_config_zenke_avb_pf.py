...
#
# title          :probabilistic/prob_cifar/hpsearch_config_resnet_avb_pf.py
# author         :ch
...
"""
Hyperparameter-search configuration for CIFAR-Resnet using Prior-Focused AVB
----------------------------------------------------------------------------
...
:mod:`probabilistic.prob_cifar.train_resnet_avb_pf`.
"""
