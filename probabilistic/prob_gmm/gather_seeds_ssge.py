...
#
# @title          :probabilistic/prob_gmm/gather_seeds_ssge.py
# @author         :ch
...
:mod:`probabilistic.prob_gmm.hpsearch_config_gmm_ssge`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run('probabilistic.prob_gmm.hpsearch_config_gmm_ssge',
