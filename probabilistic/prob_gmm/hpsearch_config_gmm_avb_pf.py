...
#
# @title          :probabilistic/prob_gmm/hpsearch_config_gmm_avb_pf.py
# @author         :ch
...
"""
Hyperparameter-search configuration for GMM tasks using Prior-Focused AVB
-------------------------------------------------------------------------
...
:mod:`probabilistic.prob_gmm.train_gmm_avb_pf`.
"""
...
# script.
_SCRIPT_NAME = 'train_gmm_avb_pf.py'
