...
#
# @title          :probabilistic/prob_gmm/gather_seeds_avb.py
# @author         :ch
...
:mod:`probabilistic.prob_gmm.hpsearch_config_gmm_avb`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run('probabilistic.prob_gmm.hpsearch_config_gmm_avb',
