...
#
# @title          :probabilistic/prob_gmm/hpsearch_config_gmm_bbb.py
# @author         :ch
...
"""
Hyperparameter-search configuration for Synthetic GMM tasks with BbB
--------------------------------------------------------------------
...
:mod:`probabilistic.prob_gmm.train_gmm_bbb`.
"""
