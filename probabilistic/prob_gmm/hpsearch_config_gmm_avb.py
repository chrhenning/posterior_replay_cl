...
#
# @title          :probabilistic/prob_gmm/hpsearch_config_gmm_avb.py
# @author         :ch
...
"""
Hyperparameter-search configuration for Synthetic GMM tasks using AVB
---------------------------------------------------------------------
...
:mod:`probabilistic.prob_gmm.train_gmm_avb`.
"""
...
grid = {
    ...
    #'dis_net_type' : ['mlp'], # 'mlp', 'chunked_mlp'
    #'dis_mlp_arch' : ['"10,10"'],
    #'dis_cmlp_arch' : ['"10,10"'],
...
_SUMMARY_KEYWORDS = hpsplitavb._SUMMARY_KEYWORDS
