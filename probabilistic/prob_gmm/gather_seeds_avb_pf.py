...
#
# @title          :probabilistic/prob_gmm/gather_seeds_avb_pf.py
# @author         :ch
...
:mod:`probabilistic.prob_gmm.hpsearch_config_gmm_avb_pf`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run('probabilistic.prob_gmm.hpsearch_config_gmm_avb_pf',
        ignore_kwds=IGNORED_KWDS, forced_params=FORCED_PARAMS,
