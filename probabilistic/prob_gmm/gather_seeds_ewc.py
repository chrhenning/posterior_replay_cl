...
#
# @title          :probabilistic/prob_gmm/gather_seeds_ewc.py
# @author         :ch
...
:mod:`probabilistic.prob_gmm.hpsearch_config_gmm_ewc`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run('probabilistic.prob_gmm.hpsearch_config_gmm_ewc',
