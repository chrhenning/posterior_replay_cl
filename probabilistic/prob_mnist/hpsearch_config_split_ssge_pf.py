...
#
# title          :probabilistic/prob_mnist/hpsearch_config_split_ssge_pf.py
# author         :ch
...
"""
Hyperparameter-search configuration for SplitMNIST using Prior-Focused SSGE
--------------------------------------------------------------------------
...
:mod:`probabilistic.prob_mnist.train_split_ssge_pf`.
"""
...
# script.
_SCRIPT_NAME = 'train_split_ssge_pf.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='split_mnist_ssge_pf', argv=argv)
