...
#
# title          :probabilistic/prob_mnist/hpsearch_config_perm_ssge.py
# author         :ch
...
"""
Hyperparameter-search configuration for permMNIST using SSGE
------------------------------------------------------------
...
:mod:`probabilistic.prob_mnist.train_perm_ssge`.
"""
...
####################################
conditions = conditions + hpsplit._BASE_CONDITIONS + \
...
# script.
_SCRIPT_NAME = 'train_perm_ssge.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='perm_mnist_ssge', argv=argv)
