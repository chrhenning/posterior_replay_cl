...
#
# title          :probabilistic/prob_mnist/hpsearch_config_perm_avb_pf.py
# author         :ch
...
"""
Hyperparameter-search configuration for PermutedtMNIST using Prior-Focused AVB
------------------------------------------------------------------------------
...
:mod:`probabilistic.prob_mnist.train_perm_avb_pf`.
...
# script.
_SCRIPT_NAME = 'train_perm_avb_pf.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='perm_mnist_avb_pf', argv=argv)
