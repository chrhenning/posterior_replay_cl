...
#
# @title          :probabilistic/prob_mnist/gather_seeds_perm_avb.py
# @author         :ch
...
:mod:`probabilistic.prob_mnist.hpsearch_config_perm_avb`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run('probabilistic.prob_mnist.hpsearch_config_perm_avb',
