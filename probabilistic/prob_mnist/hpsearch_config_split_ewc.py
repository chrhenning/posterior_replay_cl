...
"""
Hyperparameter-search configuration for SplitMNIST with EWC
-----------------------------------------------------------
...
:mod:`probabilistic.prob_mnist.train_split_ewc`.
"""
...
# script.
_SCRIPT_NAME = 'train_split_ewc.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='split_mnist_ewc', argv=argv)
