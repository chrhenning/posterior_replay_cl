...
#
# title          :probabilistic/prob_mnist/hpsearch_config_perm_avb.py
# author         :ch
...
"""
Hyperparameter-search configuration for PermutedMNIST using AVB
---------------------------------------------------------------
...
:mod:`probabilistic.prob_mnist.train_perm_avb`.
...
# script.
_SCRIPT_NAME = 'train_perm_avb.py'
