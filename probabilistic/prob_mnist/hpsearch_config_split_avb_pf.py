...
#
# title          :probabilistic/prob_mnist/hpsearch_config_split_avb_pf.py
# author         :ch
...
"""
Hyperparameter-search configuration for SplitMNIST using Prior-Focused AVB
--------------------------------------------------------------------------
...
# script.
_SCRIPT_NAME = 'train_split_avb_pf.py'
...
_ARGPARSE_HANDLE = lambda argv : targs.parse_cmd_arguments( \
    mode='split_mnist_avb_pf', argv=argv)
