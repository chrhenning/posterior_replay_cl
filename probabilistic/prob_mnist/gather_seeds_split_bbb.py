...
#
# @title          :probabilistic/prob_mnist/gather_seeds_split_bbb.py
# @author         :ch
...
:mod:`probabilistic.prob_mnist.hpsearch_config_split_bbb`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run( \
        'probabilistic.prob_mnist.hpsearch_config_split_bbb',
