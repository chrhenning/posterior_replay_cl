...
#
# title          :probabilistic/prob_mnist/hpsearch_config_perm_bbb.py
# author         :ch
...
"""
Hyperparameter-search configuration for PermutedMNIST
-----------------------------------------------------
...
:mod:`probabilistic.prob_mnist.train_perm_bbb`.
...
# script.
_SCRIPT_NAME = 'train_perm_bbb.py'
