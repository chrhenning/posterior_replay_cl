...
#
# @title          :probabilistic/prob_mnist/gather_seeds_perm_ssge.py
# @author         :ch
...
:mod:`probabilistic.prob_mnist.hpsearch_config_perm_ssge`.
"""
...
if __name__ == '__main__':
    gather_random_seeds.run( \
        'probabilistic.prob_mnist.hpsearch_config_perm_ssge',
