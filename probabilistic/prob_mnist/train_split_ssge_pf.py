...
#
# @title           :probabilistic/prob_mnist/train_split_ssge_pf.py
# @author          :mc
...
# @python_version  :3.7
"""
Prior-Focused via Spectral Stein Gradient Estimator
---------------------------------------------------
...
if __name__ == '__main__':
    config = train_args.parse_cmd_arguments(mode='split_mnist_ssge_pf')

    train_avb.run(config, experiment='split_mnist_ssge_pf')
